        ...
        <table className="table table-hover text-center">
          ...
          <tbody>
            {adversaire.map(adversaire => (
              <tr key={adversaire.adversaire_id} id={`adversaire${adversaire.adversaire_id}`} onClick={() => {
                setIDadversaire(adversaire.adversaire_id);
                ...
                <td data-label="ID dossier" className="text-nowrap">{adversaire.dossier_id}</td>
                <td data-label="Nom et Prénom" className="text-nowrap">{adversaire.nom}</td>
                <td data-label="Registre" className="text-nowrap">{adversaire.registre}</td>
                <td data-label="Adresse" className="text-nowrap">{adversaire.adresse}</td>
                <td data-label="Adresse designée" className="text-nowrap">{adversaire.adresse_d}</td>
                <td data-label="Avocat" className="text-nowrap">{adversaire.avocat}</td>
                <td data-label="Adresse Avocat" className="text-nowrap">{adversaire.adresse_a}</td>
              </tr>
            ))}
          </tbody>
        </table>
