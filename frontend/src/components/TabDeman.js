        ...
        <table className="table table-hover text-center">
          ...
          <tbody>
            {demandeurs.map(demandeur => (
              <tr key={demandeur.demandeur_id} id={`demandeur${demandeur.demandeur_id}`} onClick={() => {
                setIDDemand(demandeur.demandeur_id);
              ...
              >
                <td data-label="Nom et Prénom" className="text-nowrap">{demandeur.nom}</td>
                <td data-label="CIN" className="text-nowrap">{demandeur.cin}</td>
                <td data-label="Adresse" className="text-nowrap">{demandeur.adresse}</td>
                <td data-label="Adresse Designée" className="text-nowrap">{demandeur.adresse_d}</td>
                <td data-label="Tel" className="text-nowrap">{demandeur.tel}</td>
                <td data-label="Fax" className="text-nowrap">{demandeur.fax}</td>
              </tr>
            ))}
          </tbody>
        </table>
